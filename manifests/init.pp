class rkhunter  (
  ...
  Boolean $copy_log_on_error = $rkhunter::params::copy_log_on_error,
  $use_syslog             = $rkhunter::params::use_syslog,
  Boolean $color_set2     = $rkhunter::params::color_set2,
  Boolean $auto_x_detect  = $rkhunter::params::auto_x_detect,
  Boolean $whitelisted_is_white = $rkhunter::params::whitelisted_is_white,
  ...
  Boolean $allow_syslog_remote_logging = $rkhunter::params::allow_syslog_remote_logging,
  ...
  Boolean $use_locking    = $rkhunter::params::use_locking,
  $lock_timeout           = $rkhunter::params::lock_timeout,
  Boolean $show_lockmsgs  = $rkhunter::params::show_lockmsgs,
  ...
  Optional[Boolean] $use_sunsum = $rkhunter::params::use_sunsum,
  ...
  Boolean $phalanx2_dirtest = $rkhunter::params::phalanx2_dirtest,
  ...
  Optional[Boolean] $show_summary_warnings_number = $rkhunter::params::show_summary_warnings_number,
