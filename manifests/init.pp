class rkhunter (
  ...
  Variant[Integer[0, 2], String[1]] $allow_ssh_prot_v1 = 0,
  String[1] $enable_tests                              = 'all',
  String[1] $disable_tests                             = 'suspscan hidden_procs deleted_files packet_cap_apps apps',
  Variant[Boolean, Integer[0, 1], String[1]] $immutable_set = false,
  Boolean $allow_syslog_remote_logging                 = false,
  Stdlib::Absolutepath $suspscan_temp                  = '/dev/shm',
  Variant[Integer[0], String[1]] $suspscan_maxsize     = 10240000,
  Variant[Integer[0], String[1]] $suspscan_thresh      = 200,
  Boolean $use_locking                                 = false,
  Variant[Integer[0], String[1]] $lock_timeout         = 300,
  Boolean $show_lockmsgs                               = true,
  Optional[Variant[Integer[0, 2], Enum['0', '1', '2']]] $disable_unhide = $rkhunter::params::disable_unhide,
